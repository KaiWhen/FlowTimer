...
namespace FlowTimer {
    ...
    public partial class SettingsForm : Form {
        ...
        public SettingsForm() {
            ...
            if(tab == 1) AddKeybindSetting("-F(Next)", FlowTimer.Settings.SubFrameNext);
            if(tab == 1) AddKeybindSetting("+F(Next)", FlowTimer.Settings.AddFrameNext);
            if(tab == 1) AddKeybindSetting("-F(All)", FlowTimer.Settings.SubFrameAll);
            if(tab == 1) AddKeybindSetting("+F(All)", FlowTimer.Settings.AddFrameAll);
            if(tab == 2) AddKeybindSetting("+Frame", FlowTimer.Settings.AddFrame);
            if(tab == 2) AddKeybindSetting("-Frame", FlowTimer.Settings.SubFrame);
            if(tab == 2) AddKeybindSetting("-2F", FlowTimer.Settings.SubFrame2);
            if(tab == 2) AddKeybindSetting("-4F", FlowTimer.Settings.SubFrame4);
            if(tab == 2) AddKeybindSetting("-6F", FlowTimer.Settings.SubFrame6);
            if(tab == 2) AddKeybindSetting("-8F", FlowTimer.Settings.SubFrame8);
            if(tab == 2) AddKeybindSetting("-3F", FlowTimer.Settings.SubFrame3);
            if(tab == 2) AddKeybindSetting("-10F", FlowTimer.Settings.SubFrame10);
            if(tab == 2) AddKeybindSetting("-28F", FlowTimer.Settings.SubFrame28);
